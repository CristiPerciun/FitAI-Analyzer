...
import '../models/home_longevity_plan_day.dart' show HomeLongevityPlanDay;
...
part 'longevity_engine_models.dart';
...
class LongevityEngine {
  ...
  Future<UnifiedDailyContext> buildUnifiedDailyContext(String uid) async {
    ...
    final todayStr = dateKey(nowLocal);
    final yesterdayStr =
        dateKey(nowLocal.subtract(const Duration(days: 1)));
