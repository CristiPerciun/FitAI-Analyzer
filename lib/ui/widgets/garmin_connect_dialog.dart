        ...
        builder: (ctx, setDialogState) {
          Future<void> onConnect() async {
            ...
            if (result['success'] == true) {
              ...
              // Full-page Garmin SSO: prima `prepare` (state su Firestore), poi redirect.
              // Esito in sessionStorage se la return page è nella stessa scheda; su iOS PWA
              // spesso Safari separato → Firestore `garmin_linked` + listener in app.dart.
